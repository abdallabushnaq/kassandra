...
/**
 * VersionApi adapter that uses the current user's OIDC token for authentication.
 * The token is captured by AuthenticationProvider at the start of AI query processing.
 */
public class VersionApiAdapter extends VersionApi {
    private final AuthenticationProvider authProvider;

    public VersionApiAdapter(RestTemplate restTemplate, JsonMapper jsonMapper, AuthenticationProvider authProvider) {

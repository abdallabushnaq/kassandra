...
/**
 * SprintApi adapter that uses the current user's OIDC token for authentication.
 */
public class SprintApiAdapter extends SprintApi {
    private final AuthenticationProvider authProvider;

    public SprintApiAdapter(RestTemplate restTemplate, JsonMapper jsonMapper, AuthenticationProvider authProvider) {

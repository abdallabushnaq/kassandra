...
/**
 * FeatureApi adapter that uses the current user's OIDC token for authentication.
 */
public class FeatureApiAdapter extends FeatureApi {
    private final AuthenticationProvider authProvider;

    public FeatureApiAdapter(RestTemplate restTemplate, JsonMapper jsonMapper, AuthenticationProvider authProvider) {

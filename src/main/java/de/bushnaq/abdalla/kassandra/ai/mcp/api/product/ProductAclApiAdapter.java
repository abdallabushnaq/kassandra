...
/**
 * ProductAclApi adapter that uses the current user's OIDC token for authentication.
 * The token is captured by AuthenticationProvider at the start of AI query processing.
 */
public class ProductAclApiAdapter extends ProductAclApi {

    private final AuthenticationProvider authProvider;

    public ProductAclApiAdapter(RestTemplate restTemplate, JsonMapper jsonMapper, AuthenticationProvider authProvider) {

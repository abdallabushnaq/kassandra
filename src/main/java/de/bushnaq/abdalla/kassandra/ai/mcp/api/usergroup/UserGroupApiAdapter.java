...
/**
 * UserGroupApi adapter that uses the current user's OIDC token for authentication.
 * The token is captured by AuthenticationProvider at the start of AI query processing.
 */
public class UserGroupApiAdapter extends UserGroupApi {

    private final AuthenticationProvider authProvider;

    public UserGroupApiAdapter(RestTemplate restTemplate, JsonMapper jsonMapper, AuthenticationProvider authProvider) {

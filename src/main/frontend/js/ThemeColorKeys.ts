// theme-color-constants.ts
// Constants for all theme color keys used in chart JS files.
// These correspond to the server-side Theme.toMap() output which uses
// "themeName.fieldName" for nested theme objects.
// Color values are transmitted as 0xRRGGBB integers from the Java server.
//
...
export type ThemeColorKey = typeof ThemeColorKeys[keyof typeof ThemeColorKeys];

...
public class RearrangeStoriesAndTasksIntroductionVideo11IT extends AbstractIntroductionVideo {
    ...
    static void beforeAll() {
        ...
        video.setVersion(2);
        video.setTitle("11 Rearranging Stories and Tasks in Kassandra");

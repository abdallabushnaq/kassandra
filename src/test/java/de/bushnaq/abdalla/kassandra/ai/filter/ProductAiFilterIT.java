...
public class ProductAiFilterIT extends AbstractAiFilterTest<ProductFilterDto> {

    public ProductAiFilterIT(JsonMapper mapper, AiFilterService aiFilterService) {

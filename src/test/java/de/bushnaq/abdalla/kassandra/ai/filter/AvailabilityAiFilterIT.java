...
class AvailabilityAiFilterIT extends AbstractAiFilterTest<AvailabilityFilterDto> {

    public AvailabilityAiFilterIT(JsonMapper mapper, AiFilterService aiFilterService) {

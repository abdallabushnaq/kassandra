...
class LocationAiFilterIT extends AbstractAiFilterTest<LocationFilterDto> {

    public LocationAiFilterIT(JsonMapper mapper, AiFilterService aiFilterService) {
        super(mapper, aiFilterService, LocalDate.of(2025, 8, 10));
    }

    private Location createLocation(UUID id, String country, String state, LocalDate start,

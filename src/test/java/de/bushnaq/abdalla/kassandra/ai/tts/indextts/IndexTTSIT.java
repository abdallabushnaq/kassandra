...
package de.bushnaq.abdalla.kassandra.ai.tts.indextts;
...
public class IndexTTSIT {
    ...
    public void testDifferentVoices() throws Exception {
        ...
        for (IndexTTS.VoiceReference ref : refs) {
            ...
            Narrator          narrator = Narrator.withIndexTTS("tts/IndexTTSIT/testDifferentVoices");
    ...
    public void testEmotionalRange() throws Exception {
        ...
        Narrator narrator = Narrator.withIndexTTS("tts/IndexTTSIT/testEmotionalRange");
    ...
    public void testSpeech_03_WithSpeed() throws Exception {
        Narrator          narrator = Narrator.withIndexTTS("tts/IndexTTSIT/testSpeech_03_WithSpeed");
